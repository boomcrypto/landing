  ...
  <AppLayout>
    <section class="py-16 px-4">
      <div class="max-w-xl mx-auto">
        ...
        <h1 class="text-4xl font-bold text-center mb-6">Join Our Pro Plan Waitlist</h1>
        <p class="text-xl text-center mb-12">Sign up to be notified when Boom Smart Shops launches and get early access to our Pro plan.</p>
        ...
        <div class="bg-zinc-800 rounded-xl p-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div>
              <label for="website" class="block text-sm font-medium mb-2">Website (Optional)</label>
              <input
                type="url"
                id="website"
                v-model="website"
            ...
            <div class="pt-4">
              <button
                type="submit"
                class="w-full py-4 rounded-lg bg-fuchsia-500 text-white font-semibold hover:bg-fuchsia-600 transition-colors flex justify-center items-center"
                :disabled="loading"
              >
          ...
          <div class="mt-6 pt-6 border-t border-zinc-700 text-center text-sm text-zinc-400">
            <p>Current pricing: <span class="font-bold text-white">1.8%</span> per transaction</p>
            <p class="mt-2">Unlimited products, advanced customization, analytics dashboard, and priority support.</p>
        ...
        <div class="mt-10 text-center">
          <p class="text-lg mb-4">Just starting out?</p>
          <a href="/basic-signup" class="px-6 py-3 rounded-lg bg-zinc-700 hover:bg-zinc-600 transition font-semibold">
            Check out our Basic Plan
          </a>
        </div>
      </div>
    </section>
