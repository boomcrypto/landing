<template>
  <AppLayout>
  <section class="mx-auto max-w-4xl lg:px-8 lg:py-20 px-4 py-16 sm:px-6">
    <h1
      class="font-bold font-heading leading-tighter md:text-5xl text-4xl tracking-tighter"
    >
      Terms and Conditions
    </h1>
    <div
      class="mx-auto max-w-4xl dark:prose-a:text-blue-400 dark:prose-headings:text-slate-300 dark:prose-invert mt-8 prose prose-a:text-blue-600 prose-headings:font-bold prose-headings:font-heading prose-headings:leading-tighter prose-headings:tracking-tighter prose-img:rounded-md prose-img:shadow-lg prose-lg prose-md"
    >
      <p><em>Last updated</em>: October 06, 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            “Us” or “Our” in this Agreement) refers to Boom Platforms, Inc.,
            Dallas, TX 76227.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            Terms and Conditions agreement is a Demo.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Boom, accessible from
            <a href="https://boom.money">https://boom.money</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          By email:
          <a href="mailto:privacy@boom.money">privacy@boom.money</a>
        </li>
      </ul>
    </div>
  </section>
